...
from mapa_utils import generate_service_points, load_and_scale_map, load_coordinates_from_jsonl
...
from genetic_algorithm import calculate_total_distance_km, evolve_population, generate_random_population
